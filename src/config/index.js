...
export const API = {
  ...
  // 优惠券获取审批人
  GET_USERS: urlHandler('/couponInfo/getUsers'),
  // 导出订单
  ...
  // 里程实时入账
  MILEAGE_CONFIRM: urlHandler('/mileage/confirm'),
  // 购物车总订单下单
  ...
  // 里程查询注册码
  SELECT_REGIS_TRATION_CODE: urlHandler('/mileage/selectRegisTrationCode'),
  // 文章类目添加、编辑
  ...
  // 新优惠券 下载劵码
  GET_COUPON_CODE_EXL: urlHandler('/couponInfo/getCouponCodeExl'),
  // 新优惠券 查看明细
  ...
  // 客票退票补录
  TRFDADDED_ADDED: urlHandler('/trfdAdded/added'),
  // 客票退票补录完成
  TRFDADDED_ADDFINISHED: urlHandler('/trfdAdded/addFinished'),
  // 付费选座EMD完成补录
  PAIDSEAT_ADDFINISHED: urlHandler('/paidSeat/addFinished'),
  // 订单反馈-添加反馈
  ORDERBACK_ADD: urlHandler('/orderBack/add'),
  // 根据订单id查询反馈
  ORDERBACK_SELECTORDERBACK: urlHandler('/orderBack/selectOrderBack'),
  // 结束订单反馈
  ORDERBACK_ISDELETE: urlHandler('/orderBack/isDelete'),
  // 优惠券发放劵码
  CREATE_ISSUE: urlHandler('/couponInfo/createIssue'),
  // 新休息室下单
